...
I got a connectivity value of `r round(valid_GMM_results[1], digits = 1)` and an average silhouette of `r round(valid_GMM_results[2], digits = 1)`. These values suggest my GMM has slighlty worse internal validity than K-means.
